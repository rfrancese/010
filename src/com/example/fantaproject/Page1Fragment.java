...
public class Page1Fragment extends Fragment{
   ...
   public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState){
	...
	private class LoadFormazioniTask extends AsyncTask<Void, Void, String> {
		...
		private static final String URL = "http://pepoman.altervista.org/main.html";
		...
		protected void onPostExecute(String result) {
		        ...
		        try
		        {
		          ...
		          // TagNode primoGiocatore = (TagNode) formazioniCasa[1];
		           Log.i("dimensioneDivScoreProb","dimScore="+DivScoreProbabili.size());
		           Log.i("dimesioneFormazioniCasa","dimFCASA="+formazioniCasa.length);
		           Log.i("dimesioneFormazioniCasa","dimFFUORI="+formazioniFuori.length);
